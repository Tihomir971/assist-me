...
<button
	use:melt={$trigger}
	class="rounded-md bg-white font-medium leading-none text-magnum-700 shadow-lg focus:ring-magnum-400 inline-flex
      items-center justify-center px-4 py-2 hover:opacity-75 focus:outline-none
      focus:ring"
>
	View Notifications
</button>
